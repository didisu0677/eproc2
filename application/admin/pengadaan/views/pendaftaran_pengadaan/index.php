	...
	<div class="main-container position-relative">
		...
		<div class="float-right">
			<select class="select2 infinity custom-select" id="filter">
				<option value="1"><?php echo lang('pendaftaran_aktif'); ?></option>
				<option value="9"><?php echo lang('pendaftaran_yang_lalu'); ?></option>
			</select>
		</div>
...
<div class="content-body">
	<?php
	table_open('',true,base_url('pengadaan/pendaftaran_pengadaan/data'),'tbl_pengadaan');
		thead();
			tr();
