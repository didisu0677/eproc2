	...
	<div class="main-container position-relative">
		...
		<div class="float-right">
			<select class="select2 infinity custom-select" id="filter">
				<option value="1"><?php echo lang('evaluasi_aktif'); ?></option>
				<option value="9"><?php echo lang('evaluasi_yang_lalu'); ?></option>
			</select>
		</div>
...
<div class="content-body">
	<?php
	table_open('',true,base_url('pengadaan/evaluasi/data'),'tbl_aanwijzing');
		thead();
			tr();
