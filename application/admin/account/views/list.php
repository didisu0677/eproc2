<div class="show-panel sticky-top">
	<div class="card">
		...
		<div class="card-body dropdown-menu">
			...
			<a class="dropdown-item<?php if($uri_string == 'account/dokumen') echo ' active'; ?>" href="<?php echo base_url('account/pengalaman'); ?>"><i class="fa-award"></i><?php echo lang('pengalaman');?></a>
			<?php } ?>
