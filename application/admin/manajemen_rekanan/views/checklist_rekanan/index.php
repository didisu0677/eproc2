			...
			<div class="main-container">
				...
				<div class="table-responsive mb-2">
					<table class="table table-bordered table-detail table-app">
						<thead>
							<tr>
								<th colspan="4"><?php echo lang('checklist_dokumen'); ?></th>
							</tr>
							<tr>
								<th width="600"><?php echo lang('nama_dokumen'); ?></th>
								<th width="40"><a href="#" class="btn btn-sm btn-unduh btn-info"><i class="fa-download"></i> <?php echo lang('unduh_semua'); ?></a></th>
							...
							<tr>
								...
								<td class="text-center">						
									<div class="custom-checkbox custom-control">
										<input class="custom-control-input chk" type="checkbox" id="<?php echo 'check'. $d->id; ?>" name="<?php echo 'check['. $d->id.']'; ?>" value="<?php echo $d->id; ?>">
										<label class="custom-control-label" for="<?php echo 'check'. $d->id; ?>"></label>
									</div>
								</td>
								<td>
									<input type="text" class="form-control" autocomplete="off" id="<?php echo 'keterangan'. $d->id; ?>" name="keterangan[<?php echo $d->id; ?>]" value="" />
								</td>
							</tr>
							<?php } ?>
						</tbody>
					...
					<div class="card-body">
						<table class="table table-bordered table-detail mb-0">
							...
							<tr>
								...
								<td><?php input('text','','verifikasi_oleh','required');?></td>
							</tr>
							<tr>
								<th width="200"><?php echo lang('tanggal_verifikasi'); ?></th>
								<td><?php input('date',lang('tanggal_verifikasi'),'tanggal_verifikasi','required');?></td>
							</tr>
						</table>
					</div>
				</div>
