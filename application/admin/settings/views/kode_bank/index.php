...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/kode_bank/data'),'tbl_m_kode_bank');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('settings/kode_bank/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/kode_bank/import'),'post','form-import');
			col_init(3,9);
