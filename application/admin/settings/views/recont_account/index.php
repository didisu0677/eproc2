...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/recont_account/data'),'tbl_m_recont_account');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('settings/recont_account/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/recont_account/import'),'post','form-import');
			col_init(3,9);
