...
<div class="content-body">
	<div class="main-container">
		<form id="form-command" action="<?php echo base_url('inisiasi/template_peninjauan/save'); ?>" data-callback="reload" method="post" data-submit="ajax">
			<div class="table-responsive mb-2">
				<table class="table table-bordered table-detail table-app">
					<thead>
						<tr>
							<th><?php echo lang('aspek_yang_ditinjau'); ?></th>
							<th width="10">
