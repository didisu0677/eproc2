...
<form method="post" class="login-wrapper" action="<?php echo base_url('auth/forgot/do_reset'); ?>" id="form">
	...
	<div class="fieldset">
		...
		<input type="password" class="form-control form-control-lg" id="password" name="password" placeholder="<?php echo lang('kata_sandi_baru'); ?>" data-validation="required|min-length:8|strong_password">
	</div>
	<div class="fieldset">
