...
<?php
    form_open(base_url('auth/register/do_reg'),'post','form-reg');
        ...
        input('text',lang('nama_perusahaan'),'nama','required|max-length:100','','data-alias1="'.lang('nama_perusahaan').'" data-alias2="'.lang('nama_lengkap').'"');
        input('text',lang('npwp_perusahaan'),'npwp','required|max-length:30','','data-alias1="'.lang('npwp_perusahaan').'" data-alias2="'.lang('npwp').'"');
        ...
        input('text',lang('email'),'email','required|email|unique|max-length:50');
        ...
        input('text',lang('email') . ' (seluruh notifikasi ke vendor menggunakan email ini)','email_cp','required|email|unique|max-length:50');
        ?>
        <div class="form-group row">
